	<div class="d-flex align-items-center flex-shrink-0">
								{{-- Quick Search dibuang atas permintaan: widget bawaan Metronic
								     ini hanya mencari 2 halaman statis yang di-hardcode di JS layout,
								     bukan data absensi/siswa. JS-nya ikut dibuang di app.blade.php. --}}
								<!--begin::Activities-->
